import 'package:silenti/application/shared/providers.dart';
import 'package:silenti/presentation/state/budgets_provider.dart';
...
class _BudgetPageState extends ConsumerState<BudgetPage> {
  ...
  _requestBudgetCategories() async {
    var response = await ref.read(getExpensesCategoriesUseCaseProvider).execute();
    if (!response.status) {
    } else {
  ...
  _deleteBudget(BudgetCategory budget) async {
    var response = await ref.read(deleteBudgetCategoryUseCaseProvider).execute(budget);
